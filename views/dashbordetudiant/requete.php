<?php
if(isset($_POST["del_id_requete"], $_POST["del_name_requete"]) && !empty($_POST["del_id_requete"]) && !empty($_POST["del_name_requete"])){
    $id_requete = strip_tags($_POST["del_id_requete"]);
    $name_requete = strip_tags($_POST["del_name_requete"]);

    $donnees =["id_requete" => $id_requete];

    $add = $this->DashbordEtudiant->delete("requete", $donnees);
    if($add){
...
<header class="topbar">
    ...
    <span class="tb-title">Mes requêtes </span>
    <div class="tb-right">
  ...
  <div class="content">
    ...
    <div class="req-table">
      <?php if(empty($this->DashbordEtudiant->requetes)): ?>
        <div class="empty-state">
          ...
          <h3><?php //echo $search ? 'Aucun résultat' : 'Aucune requête'; ?></h3>
          <p><?php //echo $search ? 'Essayez un autre terme de recherche.' : 'Vous n\'avez pas encore soumis de requête.'; ?></p>
          <?php //if(!$search): ?>
            <a href="nouvelle_requete" class="btn-primary">
